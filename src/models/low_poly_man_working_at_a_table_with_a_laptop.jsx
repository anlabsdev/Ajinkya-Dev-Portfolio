...
import scene from "../assets/3d/low_poly_man_working_at_a_table_with_a_laptop.glb";
...
export function LowPolyManWorkingAtATableWithALaptop({ currentAnimation, ...props }) {
  const group = useRef();
  const { nodes, materials, animations } = useGLTF(scene);
  const { actions } = useAnimations(animations, group);
...
export default LowPolyManWorkingAtATableWithALaptop
